    ...
    <SafeAreaView>
      <View className="bg-[#2980B9] px-4 pt-4 pb-8 rounded-b-3xl">
        <View className="flex-row items-center gap-x-2 mt-8">
          ...
          <Text className="text-2xl font-bold text-white">Chapter 5</Text>
        </View>
      </View>
      <ScrollView className="h-full px-4 space-y-4">
        ...
        <Text>
          ...
          private tutors taught the young Rizal Spanish and Latin, before he was
        ...
        <Text>
          ...
          Medicine and Surgery. He, however, was not able to complete the course
          because “he became politically isolated by adversaries among the
        ...
        <Text>
          ...
          1882. According to his biographer, Austin Craig, Rizal, “in order to
          obtain a better education, had to leave his country stealthily like a
          fugitive from justice, and his family, to save themselves from
          persecution, were compelled to profess ignorance of his plans and
          movements. His name was entered in Santo Tomas at the opening of the
          new term, with the fees paid, and Paciano had gone to Manila
          pretending to be looking for this brother whom he had assisted out of
          the country.”
        </Text>
        ...
        <Text>
          ...
          specialization course at the University of Heidelberg. It was also in
          that year that Rizal’s first novel was published (in Berlin).
        </Text>

        <Text>
          Rizal is said to have had the ability to master various skills,
          subjects, and languages. Our national hero was also a doctor, farmer,
          naturalist (he discovered the Draco rizali, a small lizard; Apogania
          rizali, a beetle; and the Rhacophorus rizali, a frog), writer, visual
          artist, athlete (martial arts, fencing, and pistol shooting),
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Fr. Pablo Ramon, the Father Rector of Ateneo whom he consulted for
            a choice of career, finally answered his letter , and recommended
            medicine.
          </Text>
        </View>
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            was the second best student in a decimated class of seven who passed
            the medicine course. After which, Rizal decided to study in Spain.
          </Text>
        </View>
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            literature. It was in Madrid that he began writing Noli Me Tangere.
            He also attended classes in the University of Paris and, in 1887, he
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Formerly the Escuela Pia (Charity School)- for poor boys in Manila
            established in 1817.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            take the entrance examinations on Christian Doctrine,arithmetic, and
            reading at the College of San Juan de Letran, and passed them. His
            father was the first one who wished him to study at Letran but he
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - He was late for registration and he was sickly and undersized for
            his age (11 years old). Upon the intercession of Manuel Xerez
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            boarded in a house on CaraballoStreet, 25 min walk from the college.
            The boarding house was owned by Titay, who owed Rizal family P300.
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Jesuits trained the character of the student by rigid discipline,
            humanities and religious instruction. They heard Mass early in the
            morning before the beginning of daily class. Classeswere opened and
            closed with prayers.
          </Text>
        </View>
        <Text className="font-bold">
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Each of these empires had its rank. Students fought for positions.
            With 3 mistakes, opponent’s position could lose his position.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            newcomer and knew little Spanish.He was an externo (Carthaginians),
            occupying the end of the line. But at the end of the month, he
            became ‘emperor´ of his Empire. Hewas the brightest pupil in the
            whole class, and he was awarded a prize, a religious prize.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Rizal took private lessons in Santa Isabel College during noon
            recesses to improve his Spanish language payingthree pesos for those
            extra lessons.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            were still marked ‘Excellent' .Rizal didn’t enjoy his summer because
            his mother was in prison so Neneng (Saturnina) brought him to
            Tanawan. But without telling his father, he went to Santa Cruz to
            visit her mother in prison.He told her of his brilliant grades.
            After summer, he returned to Manila and now boarded inside
            Intramuros at No. 6 Magallanes Street. Doña Pepay, who had a widowed
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Rizal lost the class leadership. But he repented and even studied
            harder, once more became ‘emperor´. He received excellent grades in
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Doña Teodora told her son of her dream the previous night. Rizal,
            interpreting the dream, told her that she would be released from
            prison in 3 months time. It became true. Doña Teodora likened his
            son to the youthful Joseph in the Bible in his ability to interpret
            dreams.
          </Text>
        </View>
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            Alexander Dumas. His boyish imagination was stirred by the
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Fr. Francisco de Paula Sanchez- One of his professors inspired him
            to study harder and write poetry.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Rizal’s best professor in Ateneo - Rizal described him as a model
            of uprightness, earnestness, and love for the advancement of his
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            life and protect him as he steps into the world´.
          </Text>
        </View>
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            and attitude to expand the horizon of our thoughts. However, this
            would not be enough to be properly educated. Rizal thought that
            there was really an intimate alliance between religion and good
            education.
          </Text>
        </View>
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            Francis of Assisi, had a difficult pregnancy that she almost died of
            childbirth because of his big head have she not made a vow to the
            Virgin of Antipolo to make a pilgrimage to her shrine if she will
            have a safe delivery of Jose.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            her movements in the years to come. He also kept a souvenir print of
            the Virgin of Antipolo that he brings along to his travels.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - The play basically poses 7 questions related with what christians
            believe through leonido, the main character, a teenager, Rizal
            portrayed another perspective of Satan and the virgin mary. He
            centers on thoughts such as who is the real redeemer of mankind? Who
            should really be adored? Who should one believe? Hence, the play
            starts when Candido Pascual and other children were waiting for the
            coming of the Virgin Mary(through the procession)& the children
            boasted on who had the best present for the Virgin.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            Meanwhile, Pascual says that he has a flute. Before they end up in a
            fight, Candido, barged in their conversation and suggested that they
            all help one another in setting up a banca (dugout canoe) with
            colorful pennants and banners and paddle slowly into the river. He
            then asked each to bring his own present for the lady (flute, bird
            cage, flowers, and firecrackers). The rest of the children agreed.
            However, sometime later, they realized that their leader Leonido was
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - In his student life in Manila, the role of the Virgin of Antipolo
            is still prominent in his life where he notes that brings print of
            the image of the Virgin when he left home for school and later in
            his travels during his adulthood. In 1880, the Virgin of Antipolo
            would become Rizal’s muse when he wrote the zarzuela (one act play)
            entitled “Junto al Pasig” (Along the Pasig) while he was taking both
            his pre medicine and medicine proper courses at the University of
            Santo Tomas (a rare privilege for a student like him which dispels
            the long standing misinformation that he suffered mistreatment at
            the University).
          </Text>
        </View>
        <Text className="font-bold">
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            which course of study he wanted to pursue.The Jesuit priests who had
            been his former mentors had advised him to take up farming, or to
            join the order and be a man of the cloth.
          </Text>
        </View>
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - However, his taste went towards law, literature, and medicine. In
            the end, he decided to sign up for Philosophy and Letters during his
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            ...
            factors. First was Father Ramon Pablo, rector of the Ateneo, had
            advised him to pursue the course. And second was Rizal's mother had
            failing eyesight and he thought he owed it to her to become a doctor
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Unfortunately, Rizal was not happy at UST and his reflected on his
            grades. There were three main factors that contributed to his
        ...
        <View className="flex-row space-x-2 ml-4">
          <Text>
            - Likewise, Rizal was not satisfied with the system of education in
            the University. There were plenty of things to distract a young man
            in the peak of his youth. He would later find out that his real
